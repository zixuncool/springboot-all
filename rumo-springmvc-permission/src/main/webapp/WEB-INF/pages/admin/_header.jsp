...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="index">濡沫电商后台</a>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>【
					<c:forEach var="role" items="${session_user_roles}" varStatus="roleIndex">
						${role.name}${roleIndex.index < fn:length(session_user_roles)-1 ? "，":""}
					</c:forEach>
					】
				</li>
