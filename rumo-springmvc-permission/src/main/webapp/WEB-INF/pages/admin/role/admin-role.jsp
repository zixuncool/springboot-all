		...
		<tbody>
			<c:forEach items="${pageInfo.list}" var="role">
				<tr class="text-c">
					...
					<td>${role.remark}</td>
					<td class="f-14"><a title="编辑" href="javascript:;" data-opid="${role.id}" onclick="admin_role_edit('角色编辑','admin-role-add.html','${role.id}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
function admin_role_del(obj,id){
	layer.confirm('角色删除须谨慎，确认要删除吗？',function(index){
		var promise = $.post(basePath+"/admin/role/delete/"+id);
