...
/**
 * @ClassName : com.rumo.tomcat.servlet.TwoServlet
 * @Description: todo
 * @Author:mofeng
 * @Date 2018/7/28 17:01
 * @Version 1.0
 */
public class TwoServlet extends RumServlet {
    ...
    public void doPost(RumoRequest request, RumoResponse response) {
        System.out.println("请求进来了...TwoServlet");
        try {
            response.write("Two Servlet Hello World");
