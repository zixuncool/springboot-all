...
public class CaptchaController {
	 ...
	 * new Font("Courier", 1, fontSize) kaptcha.textproducer.font.size 验证码文本字符大小
	 * 默认为40 kaptcha.textproducer.font.color 验证码文本字符颜色 默认为Color.BLACK
	 * kaptcha.textproducer.char.space 验证码文本字符间距 默认为2 kaptcha.noise.impl 验证码噪点生成对象
	 * 默认为DefaultNoise kaptcha.noise.color 验证码噪点颜色 默认为Color.BLACK
	 ...
	 * 
	 * 
	 * (这里用一句话描述这个方法的作用) com.tz.web 方法名：getKaptchaImage 创建人：xuchengfei
	 * 手机号码:15074816437 时间：2016年1月5日-下午7:10:18
	 * 
	 * @param request
	 * @param response
	 * @return
	 * @throws Exception 返回类型：ModelAndView
	 * @exception @since 1.0.0
	 */
	/**
	 * (这里用一句话描述这个方法的作用) com.tz.web 方法名：getKaptchaImage 创建人：xuchengfei
	 * 手机号码:15074816437 时间：2016年1月5日-下午7:13:46
	 * 
	 * @param request
	 * @param response
	 * @return
