...
public class TmIpUtil {
	...
	public static String ipLocation(String ip) {
		String ipLocation = "";
		TmIPSeeker ipSeeker = new TmIPSeeker("qqwry.dat", "E:/kekeproject4/mkfacevip/WebRoot/WEB-INF/ip/");
	...
	public static String ipLocation(HttpServletRequest request) {
		...
		try {
			...
			String path = ResourceUtils.getFile("classpath:ip").getAbsolutePath();
